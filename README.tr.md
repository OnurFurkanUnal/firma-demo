...
* 4sequelize.sync() kullanabilirsin eðer elle eklemek istemiyorsan foreing keyleri
* 5.eðer elinle foreing keys yazýcaksan./sql/create_foreing_key.sql dosyasý içinde hazýr bulunuyor ama bu iþlemide yapmayabilirsiniz
  çünkü api gerekli kýsýtlamalarý yapýyor.
* 6.sequelize db:migrate komutunu çalýþtýr
* 7.Çerez kullanýyoruz ve bu çerezler http altýnda localhost kullanýlarak iþleniyor.Eðer windows kullanýyorsan yada baþka
...
* 8.Sýrasýyla iþlemleri tamamladýysan firma-demo dosyasýna git  node src/app.js komutunu çalýþtýr.
